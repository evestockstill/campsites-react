export const campingData = [
  {
    ...
    info: 'In addition to the breathtaking scenery, this Washington State campground is a hub for outdoor activities. The popular Thunder Knob Trail starts in the campground. The lakeside location also makes it popular for fishing, kayaking and canoeing, and swimming (but the water is very cold!).'
  },
  {
    id: 2,
    state: 'Washington',
    ...
    info: 'The Hoh Rain Forest is located in the stretch of the Pacific Northwest rainforest which once spanned the Pacific coast from southeastern Alaska to the central coast of California. The Hoh is one of the finest remaining examples of temperate rainforest in the United States and is one of the park\'s most popular destinations.'
  },
  {
    id: 3,
    state: 'oregon',
